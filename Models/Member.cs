...
namespace Coroian_Emanuel_Lab2.Models
{
    public class Member
    {
        ...
        [RegularExpression(@"^0([0-9]{4})[-. ]?([0-9]{3})[-. ]?([0-9]{3})$", ErrorMessage = "Telefonul trebuie sa inceapa cu cifra 0 si să fie de forma '0722-123-123', '0722.123.123' sau '0722 123 123'")]
